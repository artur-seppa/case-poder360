    ...
    'strategies' => [
        ...
        'responses' => configureStrategy(
            ...
            Strategies\Responses\ResponseCalls::withSettings(
                ...
                except: ['POST api/v1/auth/refresh'],
                // Recommended: disable debug mode in response calls to avoid error stack traces in responses
                // Also override cache/queue drivers so throttled routes (which hit the rate limiter's cache
                // store) don't depend on Redis being reachable while generating docs.
                config: [
                    'app.debug' => false,
                    'cache.default' => 'array',
                    'queue.default' => 'sync',
